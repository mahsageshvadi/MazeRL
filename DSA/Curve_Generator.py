...
class CurveMakerFlexible:
    ...
    def sample_curve(self, 
                     ...
                     invert_prob=0.5):        # Probability of Light Background
        
        # 1. Start with standard Dark Background / Light Vessel
        ...
        # 3. Final Clamp (Standard Normalization)
        img = np.clip(img, 0.0, 1.0)

        # 4. INVERSION LOGIC (The new feature)
        # If we flip the coin, we invert intensities: 0->1, 1->0

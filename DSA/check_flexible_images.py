...
img1, _, _ = cm.sample_curve(width_range=(1, 2), noise_prob=0.0, invert_prob=0.0)
plt.subplot(1, 3, 1); plt.imshow(img1, cmap='gray', vmin=0, vmax=1); plt.title("Phase 1: Thin/Clean")

# Sample 2: Thick, Noisy, Dark BG
img2, _, _ = cm.sample_curve(width_range=(1, 20), noise_prob=1.0, invert_prob=0.0)
...
img3, _, _ = cm.sample_curve(width_range=(3, 6), noise_prob=1.0, invert_prob=1.0)
